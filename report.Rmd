...
# datasets from Inputs needed for analysis
figureii <- read_dta("./Inputs/Data/Figures/Figure II.dta")
figureiiii_iv <- read_dta("./Inputs/Data/Figures/Figures IIII IV.dta")
...
```{r scatter2, fig.cap="Scatterplot of Distance from Jesuit Mission and Literacy Rate", echo= FALSE}
figureii <- figureii %>%
  mutate(country = ifelse(country == "BRA", "Brazil",
                          ifelse(country == "Paraguay", "Paraguay", "Argentina")))

ggplot(figureii, aes(x = distmiss, y = literacy, color = country)) + 
  geom_point() + 
  labs(x = "Distance from Jesuit Mission (km)",
       y = "Literacy Rate (%)",
...
- "OECD Assessment of the Statistical System of Argentina and Key Statistics of Argentina." 
