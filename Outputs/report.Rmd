...
```
These plots show first hand in terms of fitted values the difficulty that comes with analyzing income—there are very high outliers that affect the metrics such as mean and variation. However, at least it seems the *Residuals vs Fitted* and *Scale-Location* graphs are broadly null plots, and the *Normal Q-Q* plot is much tighter in Figure 5 than Figure 6. Again, the *Residuals vs Leverage* plot points to how there are many prominent outliers which may be affecting the data more than is appropriate.
